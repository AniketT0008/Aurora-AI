...
class GeminiService:
    ...
    def get_strategic_decision(self, agent_data, user_query):
        system_prompt  = (
            ...
            "12. REWARDING HIGH PERFORMERS: If a user has incredibly healthy metrics (e.g., high savings, high deep work hours like 6-8+ hours, low burnout) and asks whether they should work or rest/socialize, DO NOT blindly tell them to do either. Instead, output 'UNSURE' and ask them 'When was the last time you took a proper break to truly rest?' Use their context to decide: if they haven't rested recently, encourage them to go out; if they just rested, encourage them to keep working."
         )
